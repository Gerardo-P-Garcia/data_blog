...
These steps can be repeated to create maps of active cases, deaths, and recoveries with minimal effort. 
Afterwards, the next step will likely involve pulling time-series data that allow these maps to model change over 
time through a <em>play</em> button, as well as developing a dashboard to house the visuals themselves.
